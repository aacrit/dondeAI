...
**Frontend (this repo):**
1. `CLAUDE.md` — Session protocol, API contract, state shape, coding standards
2. `docs/ARCHITECTURE.md` — Code structure, module graph, loading flow
3. `docs/FEATURES.md` — What's shipped vs planned
4. `index.html` — Entry point (use offset/limit — large file)

**Backend (sibling repo):**
5. `../dondeBackend/CLAUDE.md` — V11 scoring engine, API contract, env vars, deployment
6. `../dondeBackend/docs/DATABASE.md` — Schema, RPC functions, access patterns
7. `../dondeBackend/docs/API-WORKFLOWS.md` — Request flow, pipeline inventory
8. `../dondeBackend/docs/ARCHITECTURE.md` — Repo structure, CI/CD, deployment
...
1. Read `CLAUDE.md` and `docs/ARCHITECTURE.md` in this repo
2. Read `../dondeBackend/CLAUDE.md`, `../dondeBackend/docs/DATABASE.md`, `../dondeBackend/docs/ARCHITECTURE.md`
3. Scan key source files: API endpoint handler, client-side API calls, environment configs, CI/CD workflows

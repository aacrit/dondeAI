...
2. Read `../dondeBackend/CLAUDE.md`, `../dondeBackend/docs/DATABASE.md`, `../dondeBackend/docs/API-WORKFLOWS.md`, `../dondeBackend/docs/FEATURES.md`
3. Assess the current product state across both frontend and backend

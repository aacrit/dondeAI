...
export const ICON_SVG = {
  ...
  // New deep context badge icons
  fire:          '<path fill="currentColor" d="M143.38,17.85a8,8,0,0,0-12.63,3.41l-22,60.41L84.59,58.29a8,8,0,0,0-11.93,8.57l15.82,55.37A76,76,0,1,0,210.1,107.36,111.67,111.67,0,0,0,143.38,17.85ZM128,208a60,60,0,0,1-60-60,59.45,59.45,0,0,1,.09-3.17l.22-2.68L95.63,131a8,8,0,0,0,13.26-3l20.11-55.22A95.68,95.68,0,0,1,194.37,113,59.69,59.69,0,0,1,188,148,60.07,60.07,0,0,1,128,208Z"/>',
  baby:          '<path fill="currentColor" d="M134.16,24.1a4,4,0,0,0-3.56,1.81C120.3,41.48,120,55.79,120,56a8,8,0,0,0,9.68,7.79A8.24,8.24,0,0,0,136,55.68,8,8,0,0,1,144,48h0a8,8,0,0,1,8,8.53A24.09,24.09,0,0,1,128.07,80H128a24,24,0,0,1-24-24,24.37,24.37,0,0,1,.65-5.31A4,4,0,0,0,101,46.61,100,100,0,1,0,228,128a99.47,99.47,0,0,0-89.84-99.51ZM80,128a12,12,0,1,1,12,12A12,12,0,0,1,80,128Zm96,0a12,12,0,1,1-12-12A12,12,0,0,1,176,128Zm-3.44,43.16a8,8,0,0,1-10.72,3.58,64.6,64.6,0,0,0-55.68,0,8,8,0,1,1-7.14-14.32,80.66,80.66,0,0,1,69.94,0A8,8,0,0,1,172.56,171.16Z"/>',
  forkKnife:     '<path fill="currentColor" d="M72,88V40a8,8,0,0,0-16,0V88a8,8,0,0,0,16,0ZM216,40V224a8,8,0,0,1-16,0V168H152a8,8,0,0,1-8-8,268.75,268.75,0,0,1,7.22-56.88C161.48,62.88,183.26,34,207.82,32.06A8,8,0,0,1,216,40ZM200,80c-13.88,12-24.66,37.39-29.42,72H200ZM112,40a8,8,0,0,0-16,0V88H80V40a8,8,0,0,0-16,0V88a32,32,0,0,0,24,31v105a8,8,0,0,0,16,0V119A32,32,0,0,0,128,88V40a8,8,0,0,0-16,0V88h0Z"/>',
  timer:         '<path fill="currentColor" d="M128,40a96,96,0,1,0,96,96A96.11,96.11,0,0,0,128,40Zm0,176a80,80,0,1,1,80-80A80.09,80.09,0,0,1,128,216ZM173.66,90.34a8,8,0,0,1,0,11.32l-40,40a8,8,0,0,1-11.32-11.32l40-40A8,8,0,0,1,173.66,90.34ZM96,16a8,8,0,0,1,8-8h48a8,8,0,0,1,0,16H104A8,8,0,0,1,96,16Z"/>',

  // Deep context badges icons
  calendar:      '<path fill="currentColor" d="M208,32H184V24a8,8,0,0,0-16,0v8H88V24a8,8,0,0,0-16,0v8H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32Zm0,176H48V48H72v8a8,8,0,0,0,16,0V48h80v8a8,8,0,0,0,16,0V48h24V208ZM48,80H208v-16H48Z"/>',
  clock:         '<path fill="currentColor" d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Zm64-88a8,8,0,0,1-8,8H128a8,8,0,0,1-8-8V72a8,8,0,0,1,16,0v48h48A8,8,0,0,1,192,128Z"/>',
  bolt:          '<path fill="currentColor" d="M215.79,118.17a8,8,0,0,0-5-5.66L153.18,90.9l14.66-73.33a8,8,0,0,0-13.69-7l-112,120a8,8,0,0,0,3,12.95l57.63,21.61L88.16,238.43a8,8,0,0,0,13.69,7l112-120A8,8,0,0,0,215.79,118.17Z"/>',
  chat:          '<path fill="currentColor" d="M216,48H40A16,16,0,0,0,24,64V224a15.84,15.84,0,0,0,9.25,14.5A16.05,16.05,0,0,0,40,240a15.89,15.89,0,0,0,10.25-3.78.69.69,0,0,0,.13-.11L82.5,208H216a16,16,0,0,0,16-16V64A16,16,0,0,0,216,48Zm0,144H82.5a16,16,0,0,0-10.33,3.75l-.12.11L40,224V64H216Z"/>',
  train:         '<path fill="currentColor" d="M184,24H72A32,32,0,0,0,40,56V184a32,32,0,0,0,32,32H80L65.6,235.2a8,8,0,1,0,12.8,9.6L100,216h56l21.6,28.8a8,8,0,1,0,12.8-9.6L176,216h8a32,32,0,0,0,32-32V56A32,32,0,0,0,184,24ZM72,40H184a16,16,0,0,1,16,16v48H56V56A16,16,0,0,1,72,40ZM184,200H72a16,16,0,0,1-16-16V120H200v64A16,16,0,0,1,184,200Zm-88-36a12,12,0,1,1-12-12A12,12,0,0,1,96,164Zm88,0a12,12,0,1,1-12-12A12,12,0,0,1,184,164Z"/>',
  camera:        '<path fill="currentColor" d="M208,56H180.28L166.65,35.56A8,8,0,0,0,160,32H96a8,8,0,0,0-6.65,3.56L75.72,56H48A24,24,0,0,0,24,80V192a24,24,0,0,0,24,24H208a24,24,0,0,0,24-24V80A24,24,0,0,0,208,56Zm8,136a8,8,0,0,1-8,8H48a8,8,0,0,1-8-8V80a8,8,0,0,1,8-8H80a8,8,0,0,0,6.66-3.56L100.28,48h55.44l13.62,20.44A8,8,0,0,0,176,72h32a8,8,0,0,1,8,8ZM128,88a44,44,0,1,0,44,44A44.05,44.05,0,0,0,128,88Zm0,72a28,28,0,1,1,28-28A28,28,0,0,1,128,160Z"/>',
  chair:         '<path fill="currentColor" d="M208,136V72a48,48,0,0,0-48-48H96A48,48,0,0,0,48,72v64a16,16,0,0,0-16,16v32a16,16,0,0,0,16,16v16a8,8,0,0,0,16,0V200H192v16a8,8,0,0,0,16,0V200a16,16,0,0,0,16-16V152A16,16,0,0,0,208,136ZM64,72A32,32,0,0,1,96,40h64a32,32,0,0,1,32,32v64H64ZM208,184H48V152H208Z"/>',
 ...
 * V3.6: Raised accent threshold 7→7.5 since factor recalibration lifts scores ~1-2 points.
 * More factors will reach 7+ now; keeping accent at 7 would make everything green.
 * @param {number} score — factor score (0–10)
 * @returns {string} CSS variable string
 */
export function getFactorColor(score) {
  if (score >= 7.5) return 'var(--ac)';

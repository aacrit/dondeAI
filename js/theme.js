...
const THEME_LABELS = {
  neutral: {
    ...
    chipPool: {
      cuisine: ['ramen spot', 'taco run', 'sushi counter', 'pasta night', 'burger joint', 'pho for days', 'dim sum', 'pizza slice', 'mediterranean bowl', 'korean bbq', 'french bistro', 'steak dinner', 'brunch spot', 'seafood feast', 'soup dumplings', 'korean fried chicken', 'truffle pasta', 'jerk chicken', 'smash burger'],
      vibe: ['cozy date spot', 'hidden gem', 'rooftop views', 'live music', 'outdoor patio', 'moody speakeasy', 'chill vibes', 'lively crowd', 'intimate dinner', 'neighborhood gem', 'jazz bar', 'rooftop brunch', 'cozy date night', 'speakeasy vibes'],
      ...
      time: {
        morning: ['brunch spot', 'great coffee', 'fresh pastries', 'avocado toast', 'breakfast tacos', 'bottomless brunch'],
        lunch: ['quick bite', 'power lunch', 'healthy bowl', 'soup and sandwich', 'working lunch'],
        afternoon: ['happy hour', 'afternoon tea', 'cafe vibes', 'light snack', 'espresso stop', 'after work drinks'],
    ...
    suggestionCorpus: {
      cuisines: [
        ...
        { text: 'jerk chicken', icon: 'plate', category: 'Cuisine' },
      ],
      vibes: [
        ...
        { text: 'jazz bar vibes', icon: 'music', category: 'Vibe' },
        { text: 'rooftop brunch', icon: 'brunch', category: 'Vibe' },
        { text: 'speakeasy vibes', icon: 'cocktail', category: 'Vibe' },
        { text: 'after work drinks', icon: 'cocktail', category: 'Vibe' },
